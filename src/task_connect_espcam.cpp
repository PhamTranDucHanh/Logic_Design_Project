...
const char* serverUrl = "http://192.168.1.10/capture";  // Ví dụ: IP của CAM
...
// Dùng const char* thay vì String để tiết kiệm bộ nhớ
const char* host = "192.168.1.203"; // <-- Thay IP của CAM vào đây
const int port = 80;
